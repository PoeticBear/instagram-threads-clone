...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get whoCanReply => '谁可以回复';

  @override
  String get everyoneCanReply => '所有人可以回复';

  @override
  String get followersCanReply => '仅粉丝可以回复';

  @override
  String get followingCanReply => '仅关注的人可以回复';

  @override
  String get mentionedCanReply => '仅提及的人可以回复';
  ...
  @override
  String get trendingPosts => '热门帖子';

  @override
  String get seeAllUsers => '查看全部用户';

  @override
  String get seeAllTopics => '查看全部话题';
  ...
  @override
  String get pleaseEnterUsernameAndPassword => '请输入用户名和密码';

  @override
  String get loginFailedCheckCredentials => '登录失败，请检查用户名和密码';

  @override
  String get settingsTitle => '设置';

  @override
  String get followAndInviteFriends => '关注和邀请好友';
  ...
  @override
  String get deleteAccountWarning => '将永久删除你的账号及所有相关数据，此操作无法撤销。';

  @override
  String get deleteAccountConfirm => '删除';

  @override
  String get deleteAccountFailed => '删除账号失败，请稍后重试。';

  @override
  String get accountCancellationNoticeTitle => '账号注销须知';

  @override
  String get cancellationNotice1 => '账号注销后，所有个人资料（头像、昵称、简介等）将被永久删除，无法恢复。';

  @override
  String get cancellationNotice2 => '你发布的所有帖子、回复、点赞和转发将随之清除。';

  @override
  String get cancellationNotice3 => '你的关注、粉丝、收藏以及社区成员身份将被解除。';

  @override
  String get cancellationNotice4 => '与该账号绑定的第三方登录（Apple / Google）将被解绑。';

  @override
  String get cancellationNotice5 => '注销操作不可撤销，请谨慎操作。';

  @override
  String get cancellationAgree => '我已阅读并同意上述条款';

  @override
  String get cancellationConfirm => '确认注销';

  @override
  String get cancellationConfirmMessage => '确认注销后将返回登录页面。';

  @override
  String get cancellationLoading => '正在处理注销…';
  ...
  @override
  String get tabTop => '热门';

  @override
  String get tabUsers => '用户';

  @override
  String get tabTopics => '话题';

  @override
  String get tabPosts => '帖子';

  @override
  String get sectionUsers => '用户';

  @override
  String get sectionTopics => '话题';

  @override
  String get sectionPosts => '帖子';
  ...
  @override
  String get filterReplies => '回复';

  @override
  String get filterMentions => '提及';
  ...
  @override
  String get chatEulaTitle => '最终用户许可协议';

  @override
  String get chatEulaLastUpdated => '最后更新日期：2026 年 7 月 22 日';

  @override
  String get chatEulaIntro =>
      '欢迎使用 Tweet（以下简称\"本应用\"）。本协议是您与本应用开发者（以下简称\"我们\"）之间就本应用服务的使用所订立的法律协议。';

  @override
  String get chatEulaSection1Title => '1. 接受条款';
  ...
  @override
  String get chatEulaSection2Title => '2. 用户生成内容';

  @override
  String get chatEulaSection2Body =>
      '本应用允许用户发布文字、图片，并在群聊与私信中互动。针对用户生成内容，我们实行\"零容忍\"政策。\n\n您同意不会发布任何包含以下内容的信息：\n• 色情或淫秽内容：包括但不限于裸露、性暗示或性行为描述。\n• 仇恨言论或歧视：针对种族、宗教、性别、性取向、残疾等的攻击性言论。\n• 暴力与威胁：煽动暴力、自残或对他人安全构成威胁的内容。\n• 骚扰与辱骂：针对特定个人的持续性攻击、恐吓或欺凌行为。\n• 违法内容：违反当地法律法规的任何信息。';

  @override
  String get chatEulaSection3Title => '3. 内容监管与执行';

  @override
  String get chatEulaSection3Body =>
      '为了维护社区安全，我们提供以下机制：\n• 举报机制（Flagging）：用户可以随时举报任何违反本协议的不良内容。\n• 屏蔽机制（Blocking）：用户可以随时屏蔽任何滥用用户。一旦屏蔽，该用户发布的所有内容将立即从您的视图中消失。\n• 24 小时处理承诺：我们将在收到举报后的 24 小时内对违规内容进行审查。\n• 违规处罚：一旦确认违规，我们有权在不事先通知的情况下，立即删除相关违规内容；并对违规用户进行警告、限制功能或永久封禁账号。';

  @override
  String get chatEulaSection4Title => '4. 隐私保护';
  ...
  @override
  String get chatEulaSection5Title => '5. 责任限制';

  @override
  String get chatEulaSection5Body =>
      '本应用仅作为技术平台提供服务。用户在聊天中发布的言论仅代表其个人立场，本应用不对用户生成内容的真实性、准确性或合法性承担任何法律责任。但我们将严格履行监管义务，配合相关部门调查。';

  @override
  String get chatEulaSection6Title => '6. 协议变更';

  @override
  String get chatEulaSection6Body => '我们保留随时修改本协议的权利。修订后的协议一旦公布即代替原协议。';

  @override
  String get chatEulaAgree => '同意并继续';

  @override
  String get chatEulaDisagree => '不同意';
}
